...
import { animal } from "../../constant/animal";
import { FiChevronLeft } from "react-icons/fi";
import { useNavigate } from "react-router-dom";
import background from "../../assets/images/IMG_1476.JPG";
const HewanDarat = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-row items-center">
        ...
        <h1 className="font-bold text-40px md:text-4xl text-white">Hewan Darat</h1>
      </div>
